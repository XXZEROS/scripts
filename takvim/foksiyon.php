...
return '<a href="index.php?ney=kim-la&bu='.$uye['id'].'" class="'.$dos.'">'.$uye['rumuz'].'</a>';
...
$admn=0;
$ccc = mysql_query ("select id,yil,ay,gun,durum from itiraf where yil='".$xyil."' and ay='".$xay."' and gun='".$xgun."' and durum='1'");
while ($xxx = mysql_fetch_array($ccc))  { $admn=1; }

$ccc = mysql_query ("select id,yil,ay,gun,durum from itiraf where yil='".$xyil."' and ay='0".$xay."' and gun='".$xgun."' and durum='1'");
while ($xxx = mysql_fetch_array($ccc))  { $admn=1; }

$ccc = mysql_query ("select id,yil,ay,gun,durum from itiraf where yil='".$xyil."' and ay='".$xay."' and gun='0".$xgun."' and durum='1'");
while ($xxx = mysql_fetch_array($ccc))  { $admn=1; }

$ccc = mysql_query ("select id,yil,ay,gun,durum from itiraf where yil='".$xyil."' and ay='0".$xay."' and gun='0".$xgun."' and durum='1'");
while ($xxx = mysql_fetch_array($ccc))  { $admn=1; }
return $admn;
}
