...
<div class="footer"><table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td bgcolor="#000000"><a href="yonet/" target="_blank">Yönetim Paneli</a> | 
...
<div class="sust">
  <div class="ustcuk">
  <div class="logoo"><a href="index.php"><img src="images/2.png" width="370" height="110" border="0" /></a></div>
  <div class="sust-ort"><a href="index.php"><img src="images/anasayfa.png" width="143" height="90" border="0" /></a><a href="index.php?ney=sayfa&amp;bu=1"><img src="images/kuralar.png" width="143" height="90" border="0" /></a><a href="index.php?ney=sayfa&bu=2"><img src="images/sss.png" width="143" height="90" border="0" /></a><a href="index.php?ney=<?php if(isset($_SESSION['uyeid'])){ echo 'mesajlar&amp;gnid=2&amp;msj=oku'; } else { echo 'iletisim'; } ?>"><img src="images/iletisim.png" width="143" height="90" border="0" /></a></div>
  <div class="clear"></div></div>
</div>
<div class="ortust">

<div id="menuust">
<ul><?php $mekl = mysql_query ("select * from kategori order by id asc");
while ($q = mysql_fetch_array($mekl))  { ?>
<li><a href="index.php?ney=cat&cID=<?=$q['id'];?>"><?=$q['baslik'];?></a></li>
<? } $ney=$_GET['ney'];
	     $tyil=$_GET['yil'];
		 $tay=$_GET['ay'];
		 $tgun=$_GET['gun']; ?></ul>
...
$itid=$it['id'];?>
    ...
    <div class="yorumust"></div>
          <div class="yorumort">
          <div class="yorumsys<? print yorumyokmu($itid); ?> "><center><? print yorumsayisi($itid); ?>
           
          </center></div>
          <div class="yorumic">"<a href="index.php?ney=itiraf&id=<?=$it['id'];?>"><?=$it['baslik'];?></a>"</div>
          <div class="yorumrumuz">- <? $ituye=$it['uyeid']; if($ituye<"1") { echo $it['rumuz']. ' - '.rss($it['cinsiyet']); } else { print uye($ituye);   } ?></div>
<div class="clear"></div>
        </div>
        <div class="yorumalt"></div>
	  </div>
...
$showeachside = 4 ;//  sayfalama linklerinin sayisi << 1 2 3 >> gibi :D
 ...
 $aktar = mysql_query("select * from itiraf where durum='1' order by oku desc"); 
while($veri2=mysql_fetch_array($aktar)){
$kayit_sayisi=$kayit_sayisi+1;
}
$start=$_GET['start'];
...
while ($sirala= mysql_fetch_array($aktar)) {$toplamveri++;}
	$verisay=$_GET['start'];
$aktar = mysql_query ("select * from itiraf where durum='1' order by oku desc   limit $start,$per_page"); 
while ($it = mysql_fetch_array($aktar)) {
...
<div class="clear"></div>
	  ...
	  if($_GET['ney']=="pop") { $slink="&ney=pop&cID=".$_GET['cID']; }
	  ?>
...
?>
	...
	<div class="ortsag">
	  <div class="solblok">
	    <div class="sblokbas"></div>

<div class="bttn"><center><a href="index.php?ney=itiraf-et"><img src="images/butn.png" width="228" height="52" border="0" /></a></center></div>
<? if(isset($_SESSION['uyead']) and isset($_SESSION['uyemail'])and isset($_SESSION['uyeid'])){  ?>
<div class="blokara">Kullanıcı Menüsü <div id="mon"></div></div>
...
<? } else { ?>
<div class="bttn"><center><a href="index.php?ney=giris" class="bttn"><img src="images/girsbt.png" width="228" height="52" border="0" /></a></center></div><? } ?></center>
<div class="blokara"></div>
<div class="tkvm"><? 
...
?><center><? showCalendar(); ?></center></div>
<div class="blokara">Facebook'ta biz</div>
<div class="clear"></div>
        <div class="facebok">
...
<div class="blokara">Son Yorumlar</div>
<?php  $yorrumm = mysql_query ("select id,itid,uyeid,rumuz,cinsiyet,durum from yorum where durum='1' order by id desc limit 10");
while ($yrw = mysql_fetch_array($yorrumm))  { 
	$itdurum=aitdurum($yrw['itid']);
	if($itdurum==1) {
?> 
<div class="bttns">&raquo; <a href="index.php?ney=itiraf&id=<?=$yrw['itid'];?>"><?=ait($yrw['itid']);?>.</a> için <? $ituye=$yrw['uyeid']; if($ituye<"1") { echo $yrw['rumuz']; } else { print uyex($ituye);   } ?></div>
<? } } ?>
<div class="blokara">Menü</div>
<div class="bttns">

 &raquo;  <a href="index.php?ney=cv">Editörlük Başvurusu</a><br />
 &raquo;  <a href="index.php?ney=sayfa&bu=5">Yenilikler</a><br />

 &raquo;  <a href="index.php?ney=sayfa&bu=4">Site Hakkında</a><br />

 &raquo;   <a href="index.php?ney=sayfa&bu=3">Biz Kimiz ?</a><br />

 &raquo;  <a href="index.php?ney=uye-ol">Üye Ol !</a></div>

<div class="blokara">İstatistikler</div>
<div class="bttns">
<div id="mist"></div>
</div>
<div class="blokson"></div>
      </div>
    </div>
	<div class="clear"></div>
...
<div class="enalt"><center>
  Copyright &copy; 2012  | Online Üyeler : 
...
<a href="index.php?ney=kim-la&bu=<?= $ouy['id'];?>"><?= $ouy['rumuz'];?></a><? if($syy!=$sgk) { echo ", "; } } ?> 
</center></div>
</body>
</html>