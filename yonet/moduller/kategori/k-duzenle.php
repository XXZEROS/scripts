...
$hangiid=$_GET['ID'];
$degistir = mysql_query("UPDATE kategori SET baslik='".$_POST['sayfaadi']."'
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabe">
  ...
  <tr>
    <td><? $akt = mysql_query ("select * from $tablo where id = '".$_GET['ID']."'");
while ($x = mysql_fetch_array($akt)) {  ?><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="286"  class="sod">
          <input name="sayfaadi" type="text" id="sayfaadi" value="<?= $x['baslik'];?>" size="42" />
        </td>
      </tr>
    </table></td>
